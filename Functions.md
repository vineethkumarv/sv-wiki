...
* [Calling a function with values as arguments](https://github.com/HemanthVeeramalla/control_flow/wiki/Functions#calling-a-function-with-values-as-arguments)   
* [Calling a function with variables as arguments](https://github.com/HemanthVeeramalla/control_flow/wiki/Functions#calling-a-function-with-variables-as-arguments)   
* [Calling a function with values from an expression](https://github.com/HemanthVeeramalla/control_flow/wiki/Functions#calling-a-function-with-values-from-an-expression) 
* [Calling a function with variables with positional arguments](https://github.com/HemanthVeeramalla/control_flow/wiki/Functions#calling-a-function-with-variables-with-positional-arguments)  
* [calling an automatic function](https://github.com/HemanthVeeramalla/control_flow/wiki/Functions#calling-an-automatic-function)  
* [calling a function with variables with reference of variables](https://github.com/HemanthVeeramalla/control_flow/wiki/Functions#calling-a-function-with-variables-with-reference-of-variables)   
* [calling a function with a void return type](https://github.com/HemanthVeeramalla/control_flow/wiki/Functions#calling-a-function-with-a-void-return-type)   
* [calling a function with return an array](https://github.com/HemanthVeeramalla/control_flow/wiki/Functions#calling-a-function-with-return-an-array)  
* [calling a function from an expression that returns an array](https://github.com/HemanthVeeramalla/control_flow/wiki/Functions#calling-a-function-from-an-expression-that-returns-an-array)      
* [Calling a task from function(exceptional case by using fork and join_none)](https://github.com/HemanthVeeramalla/control_flow/wiki/Functions#calling-a-task-from-a-function)  
