...
|2.| [Relational operator](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/operators#2relational-operator)|
|3.| [Equality operator](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/operators#3equality-operator)|
|4.| [Logical Operator](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/operators#4logical-operator)|
|5.| [Bitwise Operator](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/operators#5bitwise-operator)|
|6.| [Shift Operator](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/operators#6shift-operator)|
|7.| [Conditional Operator](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/operators#7conditional-operator)|
|8.| [Reduction Operator](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/operators#8reduction-operator)|
|9.| [Concatenation and Replication Operators](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/operators#9concatenation-and-replication-operators)|
