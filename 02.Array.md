...
function element_t push_front (); | queue1.push_front(); | inserts the given element at the front of the queue
function element_t push_back (); | queue1.push_back(); | inserts the given element at the end of the queue
function void pop_front (input element_t item); | queue1.pop_front("yelahanka") | removes and returns the first element of the queue
function void pop_back (input element_t item); | queue1.pop_back("udupi") | removes and returns the last element of the queue
