...
Sometimes there will be necessity to access the members of parent class by the child class. This can be done by the keyword **'protected'**. By using **protected**, all the child classes will get the access to the base class members which are data protected.
...
![public new](https://user-images.githubusercontent.com/110398433/191605400-5f2d2c8a-6a5b-4354-94b6-452898a8d5b1.png)
