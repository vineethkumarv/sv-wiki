...
what happned if do not use the this keyword:-
...
extern keyword :-
An extern method provides a facility for class methods to define them outside of the class body.If the method definition is lengthy (many lines of code inside a method), the extern method provides better readability and cleaner implementation of the class.
...
syntax:-
 ...
 //method declaration - extern indicates out-of-body declaration
 
 extern function <function_name>;
 extern task <task_name>;  

 //method implementation outside class body using  scope resolution operator  
